...
const routes: Routes = [
  ...
  },
  {
    path: "game",
    loadChildren: () =>
      import("./game/in-game/game.module").then((m) => m.GamePageModule),
  },
  {
    path: "game/:matchId",
    loadChildren: () =>
  ...
  },
  {
    path: "competition",
    loadChildren:
      "./forms/competition/competition.module#CompetitionPageModule",
  },
  {
    path: "competition/:id",
    loadChildren:
  ...
  },
  {
    path: "competitions",
    loadChildren:
      "./list/competitions/competitions.module#CompetitionsPageModule",
  },
  {
    path: "match",
  ...
  {
    path: "before-game",
    loadChildren: "./game/before-game/before-game.module#BeforeGamePageModule",
  },
  {
    path: "after-game",
    loadChildren: "./game/after-game/after-game.module#AfterGamePageModule",
  },
  {
    path: "after-game/:matchId",
    loadChildren: "./game/after-game/after-game.module#AfterGamePageModule",
  },
  {
    path: "reports",
  ...
  {
    path: "report/competition/list",
    loadChildren:
      "./reports/competition/list/competitions.module#CompetitionsPageModule",
  },
  {
    path: "report/competition/report/:id",
    loadChildren:
      "./reports/competition/report/competition.module#CompetitionPageModule",
  },
  {
    path: "report/match/report/:id",
    loadChildren: "./reports/match/report/match.module#MatchPageModule",
  },
  {
    path: "report/match/report/:id/action-detail/:actionName",
    loadChildren:
